"""
Fix Payment PAY-000138 - Revert schedule marked as paid for pending payment
"""
import os
import sys
import django
...
print("=" * 70)
print("FIXING PAYMENT PAY-000138")
print("=" * 70)

# Get the payment
try:
    payment = Payment.objects.get(payment_number='PAY-000138')
...
if payment.status == 'pending' and schedule.is_paid:
    ...
    # Also revert PaymentCollection if it exists
