...
urlpatterns = [
    ...
    path('manager/collections/', views.manager_collections_hierarchical, name='manager_collections_hierarchical'),
    path('manager/view-officer/<int:officer_id>/', views.view_officer_dashboard, name='view_officer_dashboard'),
